...
// Filter Method
// The map method will loop over an array and check with the condition and return an new array
...
const longBooksWithMovie = books.filter(book => book.pages > 900).filter(book => book.hasMovieAdaptation);
